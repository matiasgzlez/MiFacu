...
const Character = memo<CharacterProps>(
    ({ char, style, index, animationConfig, enterFrom, enterTo, exitFrom, exitTo }) => {
        ...
        const blurIntensity = useSharedValue(maxBlur);
        ...
        const enteringAnimation = () => {
            ...
            return {
                ...
                animations: {
                    ...
                    transform: [
                        { translateY: withDelay(enterDelay, withSpring(enterTo.translateY, springConfig)) },
                        { scale: withDelay(enterDelay, withSpring(enterTo.scale, springConfig)) },
                        { rotate: withDelay(enterDelay, withSpring(`${enterTo.rotate}deg`, springConfig)) },
                    ],
                },
            };
        };
        ...
        const exitingAnimation = () => {
            ...
            return {
                ...
                animations: {
                    ...
                    transform: [
                        { translateY: withDelay(exitDelay, withTiming(exitTo.translateY, timingConfig)) },
                        { scale: withDelay(exitDelay, withTiming(exitTo.scale, timingConfig)) },
                        { rotate: withDelay(exitDelay, withTiming(`${exitTo.rotate}deg`, timingConfig)) },
                    ],
                },
            };
        };
        ...
        return (
            <Animated.View
                ...
                layout={LinearTransition.duration(animationConfig.layoutTransitionDuration).easing(Easing.out(Easing.ease))}
...
export const StaggeredText = memo<StaggeredTextProps>(
    ({ text, style, animationConfig, enterFrom, enterTo, exitFrom, exitTo }) => {
        ...
        const mergedEnterFrom: CharacterAnimationParams = { ...DEFAULT_ENTER_FROM, ...enterFrom };
        const mergedEnterTo: CharacterAnimationParams = { ...DEFAULT_ENTER_TO, ...enterTo };
        const mergedExitFrom: CharacterAnimationParams = { ...DEFAULT_EXIT_FROM, ...exitFrom };
        const mergedExitTo: CharacterAnimationParams = { ...DEFAULT_EXIT_TO, ...exitTo };

        return (
            <Animated.View
                style={styles.textWrapper}
                layout={LinearTransition.duration(mergedAnimationConfig.layoutTransitionDuration).easing(Easing.out(Easing.ease))}
            >
